...
<h1 class="my-5 text-center">Eun Bee 회원가입</h1>
<div class="container mb-5">
   <form name="registerform" class="registerform" action="/board/MembersOk" method="post">
      ...
      <div class="mb-3 mt-3">
         <div class="row">
            ...
            <div class="col-md-9 mt-3 col-md-offset-1">
               <input type="text" name="addr" id="addr" class="form-control" placeholder="주소" readonly />
            </div>
            <div class="col-md-2"></div>
            <div class="col-md-9 mt-3 col-md-offset-1">
      ...
      <div class="mb-3 mt-3">
         <div class="row">
            <label for="tel" class="col-md-2 form-label">
               전화번호 :
            </label>
            <div class="col-md-3">
